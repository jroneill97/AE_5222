...
%% x2
funs(7) = states(7) - 2;
funs(8) = states(8) - states(25);
funs(9) = states(9) - states(26);
funs(10) = states(10) - states(27);
funs(11) = states(11) - states(28);
funs(12) = states(12) - states(29);

%% p1
funs(13) = states(13) - 0.1 * states(1);
funs(14) = states(14) - 0.1 * states(2);
funs(15) = states(15) - 0.1 * states(3);
funs(16) = states(16) - 0.1 * states(4);
funs(17) = states(17) - 0.1 * states(5);
funs(18) = states(18) - 0.1 * states(6);
...
funs(24) = states(24) - 0.05 * states(13);
